    ...
    <div>
      ...
      <main>
        ...
        <section className="second-section">
          ...
          <Order img='pin.svg' steps='Choose your location' />
          <Order img='bow.svg' steps='Choose what to eat' />
          <Order img='burger.svg' steps='Make your first order' />
          <Order img='Home.svg' steps='Now! Your food on  way ' />
          </div>
        </section>
